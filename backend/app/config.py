...
class Settings:
    ...
    tractive_email: str | None = os.environ.get("TRACTIVE_EMAIL")
    tractive_password: str | None = os.environ.get("TRACTIVE_PASSWORD")
    tractive_enabled: bool = bool(tractive_email and tractive_password)

    notify_webhook_url: str | None = os.environ.get("NOTIFY_WEBHOOK_URL")
